//
//  AddbookRecipeViewController.swift
//  FavRecipe
//
...
class AddbookRecipeViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate,UITextFieldDelegate, UITextViewDelegate{
    ...
    @IBOutlet var recipebookTextField: UITextField!
    ...
    override func viewDidLoad() {
        ...
        self.recipebookTextField.delegate = self
        ...
        if recipeData != nil {
            ...
            recipebookTextField.text = recipeData.recipeURL
            memoTextView.text = recipeData.memo
            recipeTitleTextField.isEnabled = false
            recipebookTextField.isEnabled = false
    ...
    @IBAction func didTapEdit(){
        ...
        recipebookTextField.isEnabled = true
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        recipebookTextField.resignFirstResponder()
    ...
    @IBAction func addRecipe(_ sender: Any) {
        ...
        if recipeData != nil {
            ...
            try! realm.write {
                ...
                recipeData.recipebook = recipebookTextField.text!
        ...
        //nilだったら新しいのを作る
            ...
            newRecipe.recipebook = recipebookTextField.text!
